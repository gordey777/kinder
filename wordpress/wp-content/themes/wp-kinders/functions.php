...
// Studios
// Add news Post Type
add_action( 'init', 'post_type_studios' );
function post_type_studios() {
...
function taxonomies_category() {
  ...
  register_taxonomy( 'categories', array( 'studios', 'gallery' ), $args );
  register_taxonomy( 'categories', array( 'studios', 'gallery' ), $args );
  ...
  register_taxonomy( 'tagers', array( 'studios', 'gallery' ), $args );
